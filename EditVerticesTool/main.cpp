...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("EditVerticesTool"));
    ...
    QAction* deleteVertexAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Delete Vertex"));
    deleteVertexAction->setShortcut(Qt::Key_Delete);
    QAction* resetAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/refresh.svg")), QStringLiteral("Reset Shapes"));
