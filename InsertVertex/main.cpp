...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("InsertVertex"));
    ...
    QAction* insertAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/add.svg")), QStringLiteral("Insert Vertex"));
