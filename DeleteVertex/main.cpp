...
QAction* addToolAction(
    ...
    GisViewerTool tool)
{
    QAction* action = toolbar.addAction(QIcon(iconName), text);
...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("DeleteVertex"));
    ...
    addToolAction(*toolbar, toolGroup, QStringLiteral("Pan"), QStringLiteral(":/icons/pan.svg"), *viewer, GisViewerTool::Pan);
    QAction* selectAction = addToolAction(*toolbar, toolGroup, QStringLiteral("Select"), QStringLiteral(":/icons/select.svg"), *viewer, GisViewerTool::Info);
    QAction* editVerticesAction = addToolAction(*toolbar, toolGroup, QStringLiteral("Edit Vertices"), QStringLiteral(":/icons/vertex.svg"), *viewer, GisViewerTool::EditVertices);
    editVerticesAction->setChecked(true);
    toolbar->addSeparator();

    QAction* deleteSelectedVertexAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Delete Selected Vertex"));
    ...
    QAction* deleteByIndexAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Delete By Index"));
    QAction* resetAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/refresh.svg")), QStringLiteral("Reset Shape"));
