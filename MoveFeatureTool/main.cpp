...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("MoveFeatureTool"));
    ...
    QAction* moveAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/move.svg")), QStringLiteral("Move Feature"));
