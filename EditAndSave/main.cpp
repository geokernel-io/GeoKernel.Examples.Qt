...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("EditAndSave"));
    ...
    QAction* addPointAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/point.svg")), QStringLiteral("Add Point"));
    ...
    toolbar->addSeparator();
    QAction* saveAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/save.svg")), QStringLiteral("Save Shapefile"));
