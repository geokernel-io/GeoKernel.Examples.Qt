...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("MultiLayerEdit"));
    ...
    QAction* redLayerAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/point.svg")), QStringLiteral("Active: Red Points"));
    redLayerAction->setCheckable(true);
    activeLayerGroup.addAction(redLayerAction);

    QAction* blueLayerAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/point.svg")), QStringLiteral("Active: Blue Points"));
    blueLayerAction->setCheckable(true);
    activeLayerGroup.addAction(blueLayerAction);

    toolbar->addSeparator();
    QAction* addAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/add.svg")), QStringLiteral("Add To Active Layer"));
    QAction* commitAllAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/save.svg")), QStringLiteral("Commit Both"));
    QAction* rollbackAllAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/rollback.svg")), QStringLiteral("Rollback Both"));
