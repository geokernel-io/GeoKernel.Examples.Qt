#ifndef GEOKERNEL_RASTER_WORLD_TRANSFORM_SAMPLE_SUPPORT_H
#define GEOKERNEL_RASTER_WORLD_TRANSFORM_SAMPLE_SUPPORT_H
...
inline bool downloadFile(const QUrl& url, const QString& targetPath, QWidget* parent)
{
    ...
    request.setHeader(QNetworkRequest::UserAgentHeader,
        QStringLiteral("GeoKernel RasterWorldTransform"));
    ...
    if (!succeeded)
    {
        ...
        QMessageBox::critical(parent, QStringLiteral("RasterWorldTransform"),
