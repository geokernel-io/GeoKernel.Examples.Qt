#ifndef GEOKERNEL_MIF_LOAD_SAMPLE_SUPPORT_H
#define GEOKERNEL_MIF_LOAD_SAMPLE_SUPPORT_H
...
inline bool downloadFile(const QUrl& url, const QString& targetPath, QWidget* parent)
{
    ...
    request.setHeader(QNetworkRequest::UserAgentHeader,
        QStringLiteral("GeoKernel MifLoad"));
    ...
    if (!succeeded)
    {
        ...
        QMessageBox::critical(parent, QStringLiteral("MifLoad"),
