#ifndef GEOKERNEL_RASTER_TILE_CACHE_SAMPLE_SUPPORT_H
#define GEOKERNEL_RASTER_TILE_CACHE_SAMPLE_SUPPORT_H
...
inline bool downloadFile(const QUrl& url, const QString& targetPath, QWidget* parent)
{
    ...
    request.setHeader(QNetworkRequest::UserAgentHeader,
        QStringLiteral("GeoKernel RasterTileCache"));
    ...
    if (!succeeded)
    {
        ...
        QMessageBox::critical(parent, QStringLiteral("RasterTileCache"),
