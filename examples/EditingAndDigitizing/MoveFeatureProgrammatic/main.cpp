...
int main(int argc, char* argv[])
{
    ...
    QAction* moveWestAction = toolbar->addAction(sampleIcon(QStringLiteral("Move.svg")), QStringLiteral("Move West"));
    QAction* moveEastAction = toolbar->addAction(sampleIcon(QStringLiteral("Move.svg")), QStringLiteral("Move East"));
    QAction* moveNorthAction = toolbar->addAction(sampleIcon(QStringLiteral("LayerUp.svg")), QStringLiteral("Move North"));
    QAction* moveSouthAction = toolbar->addAction(sampleIcon(QStringLiteral("LayerDown.svg")), QStringLiteral("Move South"));
    toolbar->addSeparator();
