...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("SelectAdd"));
    ...
    QAction* selectAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/select.svg")), QStringLiteral("Select Add"));
