...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("AddPolylineProgrammatic"));
    ...
    QAction* addPolylineAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/polyline.svg")), QStringLiteral("Add Polyline"));
    QAction* clearAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Clear Lines"));
