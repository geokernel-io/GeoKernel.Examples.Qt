...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("SetAttributes"));
    ...
    QAction* applyAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/edit.svg")), QStringLiteral("Apply Attributes"));
