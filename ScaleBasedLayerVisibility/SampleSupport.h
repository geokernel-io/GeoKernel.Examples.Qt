#ifndef GEOKERNEL_LAYER_ADD_REMOVE_SAMPLE_SUPPORT_H
#define GEOKERNEL_LAYER_ADD_REMOVE_SAMPLE_SUPPORT_H
...
inline bool downloadFile(const QUrl& url, const QString& targetPath, QWidget* parent)
{
    ...
    request.setHeader(QNetworkRequest::UserAgentHeader,
        QStringLiteral("GeoKernel ScaleBasedLayerVisibility"));
    ...
    if (!succeeded)
    {
        ...
        QMessageBox::critical(parent, QStringLiteral("ScaleBasedLayerVisibility"),
