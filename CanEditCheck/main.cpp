...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("CanEditCheck"));
    ...
    QAction* beginEditAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/edit.svg")), QStringLiteral("Begin Edit"));
    QAction* commitAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/save.svg")), QStringLiteral("Commit Edit"));
    QAction* rollbackAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/rollback.svg")), QStringLiteral("Rollback Edit"));
