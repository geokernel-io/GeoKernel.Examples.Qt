...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("AddWithAttributes"));
    ...
    QAction* addPointAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/point.svg")), QStringLiteral("Add Point With Attributes"));
    QAction* infoAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/identify.svg")), QStringLiteral("Info"));
    infoAction->setCheckable(true);
    QAction* clearAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Clear Points"));
