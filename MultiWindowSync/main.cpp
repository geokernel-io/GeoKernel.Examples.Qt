...
QAction* addToolbarIcon(QToolBar& toolbar, const QString& iconName, const QString& caption)
{
    QAction* action = toolbar.addAction(
        QIcon(QStringLiteral(":/icons/%1").arg(iconName)), QString());
...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("MultiWindowSync"));
    ...
    QAction* zoomInAction = addToolbarIcon(*toolbar, QStringLiteral("zoom-in.svg"), QStringLiteral("Zoom In"));
    QAction* zoomOutAction = addToolbarIcon(*toolbar, QStringLiteral("zoom-out.svg"), QStringLiteral("Zoom Out"));
    QAction* fullExtentAction = addToolbarIcon(*toolbar, QStringLiteral("full-extent.svg"), QStringLiteral("Full Extent"));
    QAction* syncAction = toolbar->addAction(QStringLiteral("Sync On"));
    ...
    QAction* zoomBoxAction = addToolbarIcon(*toolbar, QStringLiteral("zoom-box.svg"), QStringLiteral("Zoom Rect"));
