...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("UndoRedo"));
    ...
    QAction* addPointAction = addToolAction(*toolbar, toolGroup, QStringLiteral("Add Point"), QStringLiteral(":/icons/point.svg"), *viewer, GisViewerTool::AddPoint);
    ...
    QAction* undoAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/undo.svg")), QStringLiteral("Undo"));
    QAction* redoAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/redo.svg")), QStringLiteral("Redo"));
    QAction* undoFiveAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/undo.svg")), QStringLiteral("Undo 5"));
    QAction* redoFiveAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/redo.svg")), QStringLiteral("Redo 5"));
    QAction* resetAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/refresh.svg")), QStringLiteral("Reset"));
