...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("SnappingEnabled"));
    ...
    QAction* addLineAction = addToolAction(*toolbar, toolGroup, QStringLiteral("Add Polyline"), QStringLiteral(":/icons/polyline.svg"), *viewer, GisViewerTool::AddPolyline);
    ...
    QAction* snappingAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/snapping.svg")), QStringLiteral("Snapping"));
    ...
    QAction* resetAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/refresh.svg")), QStringLiteral("Reset Guide"));
