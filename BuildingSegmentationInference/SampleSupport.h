...
inline bool downloadFile(const QUrl& url, const QString& targetPath, QWidget* parent)
{
    ...
    QProgressDialog progress(QStringLiteral("Downloading building-segmentation sample..."),
    ...
    if (!succeeded) {
        ...
        QMessageBox::critical(parent, QStringLiteral("BuildingSegmentationInference"),
