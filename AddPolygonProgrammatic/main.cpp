...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("AddPolygonProgrammatic"));
    ...
    QAction* addPolygonAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/polygon.svg")), QStringLiteral("Add Polygon"));
    QAction* clearAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Clear Polygons"));
