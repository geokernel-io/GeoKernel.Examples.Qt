...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("DeleteFeature"));
    ...
    QAction* deleteOneAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Delete Feature"));
    QAction* deleteSelectedAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/delete.svg")), QStringLiteral("Delete Selected"));
