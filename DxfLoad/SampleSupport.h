#ifndef GEOKERNEL_DXF_LOAD_SAMPLE_SUPPORT_H
#define GEOKERNEL_DXF_LOAD_SAMPLE_SUPPORT_H
...
inline bool downloadFile(const QUrl& url, const QString& targetPath, QWidget* parent)
{
    ...
    request.setHeader(QNetworkRequest::UserAgentHeader,
        QStringLiteral("GeoKernel DxfLoad"));
    ...
    if (!succeeded)
    {
        ...
        QMessageBox::critical(parent, QStringLiteral("DxfLoad"),
