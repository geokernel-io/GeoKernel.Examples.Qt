...
bool addLayer(GisViewer& viewer, const QString& name, const QString& zipName,
    const QString& targetFolder, const QString& requiredFileName, QWidget* parent,
    const std::function<void(GisLayer&)>& configure = {})
{
...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("LayerAddRemove"));
