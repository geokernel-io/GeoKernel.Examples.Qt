...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("WorldTolerance"));
    ...
    QAction* identifyAction = toolbar->addAction(QIcon(QStringLiteral(":/icons/identify.svg")), QStringLiteral("World Tolerance Hit Test"));
